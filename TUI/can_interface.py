...
class CANinterface:
    ...
    def process_message(self, msg):
        ...
        if msg.arbitration_id == 0x18F01D21:  # steering
            ...
            # J1939 PGN 65256 pitch is offset-encoded: 1/128 deg per bit with
            # a -200 deg offset, so the raw field sits near 25600 for level.
            # Without the offset this reported ~198.7 deg for a boat sitting
            # flat, which made the pitch/roll attribution in the heading
